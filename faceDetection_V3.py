# -*- coding: utf-8 -*-
"""
Created on Fri Mar  8 11:45:03 2019
...
class faceDetection:
    ...
    def getFaceEncoding(self, frame, face_locations):
        return face_recognition.face_encodings(frame, face_locations, num_jitters=20)
...
if __name__=='__main__':
    ...
    #frame = cv2.imread(os.path.join('raw_data','Abhinav','Abhinav.jpg'))
